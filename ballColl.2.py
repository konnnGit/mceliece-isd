...
def ballcoll(c,H,t,p,q,l):
    ...
    while alg:
        ...
        if HP[:,k:n].det()!=0:
            ...
            #In this BCD implementetion k1=k2 but k1=2k2
            L1,L2=getBCD(k,p)  
            ...
            #If input q==-1 then the l coordinates will be a zero vector=> q1=q2=0
            eMlist=[]
            if q==-1:
                #l1,l2=getB(l,0)
                eM=sympy.zeros(1,l)
            ...
            #find the possible l1=l2 size vectors with q1=q2 errors. So, we use the utility function getB used in Stern, too. In other words this is the ẽM.
                l1,l2=getB(l,q)             
            	for el1 in  l1:
                	for el2 in l2: 
                   		eM=el1.row_join(el2)#concatenate the l1,l2 size vectors
                   		eMlist.append(eM)
